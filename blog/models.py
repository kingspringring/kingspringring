...
def user_directory_path(instance, filename):
    ...
    # username
    # return 'avatar/{0}/{1}/{2}/{3}'.format(year, month, day, instance.username+filename)

    # random
    # return 'avatar/{0}/{1}/{2}/{3}'.format(year, month, day, str(random.randint(1, 9999999))+'.'+filename.split('.')[1])

    # md5
    filename_prefix = filename.split('.')[0]
    filename_postfix = filename.split('.')[1]
    m = hashlib.md5()
    m.update(filename_prefix)
...
class Article(models.Model):
    ...
    get_tags.admin_order_field = 'tag'
